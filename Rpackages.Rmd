...
- [DT](https://rstudio.github.io/DT/): Create javascript DataTables in R - searchable, sortable, interactive data tables

- [rexcel](https://github.com/rsheets/rexcel): Extract spreadsheet data from Excel workbooks

- [jailbreakr](https://github.com/rsheets/jailbreakr): Extract formulas, metadata, etc. from Excel workbooks. Still very much in beta as of August 2016. 
