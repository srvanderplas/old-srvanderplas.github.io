...
Yes, yes, there is. In fact, I think there are many. I'd like to avoid scraping UrbanDictionary, however, so we'll go with the (current) [first search hit](http://cltampa.com/dailyloaf/archives/2012/09/16/dirty-sex-dictionary?showFullText=true) on google for "dirty words dictionary". 
...
defs <- defs[-grepl("sex: ask your mother.", defs)]
