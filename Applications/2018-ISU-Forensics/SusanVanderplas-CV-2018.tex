...
Conducted analyses to improve NPPD's data-driven decision making, including analysis of safety, profitability, and reliability data. Designed the Business Intelligence Embedded Agent program to train employees in statistical programming, data analysis, data visualization, and basic statistical modeling.}%
% \begin{itemize}
...
\cvcolumn[0.6]{\textbf{\footnotesize{FORENSICS}}}{
    \begin{itemize}
...
\tllabelcventry{2013}{2014}{2013-2014}{R Workshops}{Iowa State}{}{}{}
...
\cvitem{In Progress}{
    ...
    \item [Longitudinal Shoe Database] Features of a database for longitudinal shoe data, collected using many techniques. 
    ...
    \item [Continuous Integration and Unit Testing in Forensics Software] Best practices for development of forensics software, including use of continuous integration, unit testing, version control systems, and open-source licensing.
...
\tldatecventry{2018}{\texttt{x3ptools}}{Reading, manipulating, and visualizing x3p files (with Heike Hofmann)}{}{}{}
