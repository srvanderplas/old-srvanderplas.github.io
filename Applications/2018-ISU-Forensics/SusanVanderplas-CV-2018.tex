...
Conducted analyses to improve NPPD's data-driven decision making, including analysis of safety, profitability, and reliability data. Designed a program to train employees in statistical programming, data analysis, data visualization, and basic statistical modeling.}%
% \begin{itemize}
