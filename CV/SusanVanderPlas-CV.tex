...
\tllabelcventry{2011}{0}{2011--15*}{Doctor of Philosophy in Statistics}{Iowa State University}{}{}{Anticipated Graduation: Feb. 2015}
...
\tlcventry{2012}{0}{PhD Research}{Iowa State University}{}{Ames, IA}{Designed and analyzed experiments to understand human perception of statistical graphics and optimized graphics to clearly communicate statistical results. \cite{jsm2014userpanel}%
\begin{itemize}%
...
\tlcventry{2013}{0}{Research Asst., USDA Soybean Genome Project}{Iowa State Univ.}{Ames, IA}{}{
\begin{itemize}
...
\tllabelcventry{2012}{2012.8}{Jan-Aug 2012}{Research Asst., Iowa Dept. of Transportation}{Iowa State Univ.}{Ames, IA}{}{Developed a hierarchical Bayesian model to determine the effectivieness of road interventions on traffic accidents and fatalities. Discovered a previously unknown error in the data used in prior analyses using exploratory techniques, and developed a method to compensate for the missing data.}

\tlcventry{2010}{2011}{M.S. Research}{Iowa State University}{Ames, IA}{}{Worked with materials scientists and engineers to develop and implement nonparametric methods for automatic peak detection in mass spectroscopy data. Helped to fit systems of differential equations to spectroscopy data based on theoretical concepts from quantum physics to failictate inference about the atomic structure of a material.}

\tllabelcventry{2009.4}{2009.8}{Summer 2009}{NSF Research Experience for Undergraduates}{Iowa State University}{Ames, IA}{}{Worked with biologists and bioinformaticians to compare homologous gene expression in humans, pigs, and mice.\cite{towfic2010detection}}

\tllabelcventry{2008.4}{2008.8}{Summer 2008}{NSF Research Experience for Undergraduates}{University of Nebraska}{Lincoln, NE}{}{Created a mathematical model describing electrical impulse transmission and decay along neurons with varying states of myelination.}
...
\tlcventry{2013}{2014}{Animint Developer}{R Project}{Google Summer of Code}{}{Worked to develop the \texttt{animint} package for R to translate \texttt{ggplot2} into d3 interactive JavaScript graphics. Participated in the project in 2013, adding support for all ggplot2 geoms as well as most scales and axes. Returned to serve as a mentor for the project in 2014. \cite{animintmanual,gprug2014} (\href{https://github.com/tdhock/animint}{Project Website})}

\section{Consulting}
\tllabelcventry{2012.8}{0}{2012}{Informal Consultant}{Cooper Nuclear Station}{Brownville, NE}{}{Provided informal statistical recommendations to nuclear engineers on proper methods for bootstrap, k95/95 intervals, probability analysis, and other modeling questions. Helped to estimate capacity factor using block bootstrap, answed questions about probability theory and model assessment, and assessed violations of modeling assumptions. Assembled data sets containing years of hourly power prices to explore downpower timing and market relationships.}
