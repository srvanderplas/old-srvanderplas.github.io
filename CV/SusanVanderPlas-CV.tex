...
\tllabelcventry{2015.4}{2015.10}{Summer 2015}{Postdoc}{Office of the Vice President for Research}{Iowa State University}{Ames, IA}{Examined trends in startup packages provided to new faculty at Iowa State over time and the association between startup funding and future performance (publications, grant applications, and grant awards).}
\tlcventry{2012}{2015}{PhD Research}{Iowa State University}{}{Ames, IA}{Designed and analyzed experiments to understand human perception of statistical graphics and optimized graphics to clearly communicate statistical results. \cite{jsm2014userpanel}%
\begin{itemize}%
\item The \href{https://github.com/heike/sine-illusion}{Sine Illusion} in Statistical Graphics: How does this common illusion effect the information we take in from graphs? \cite{sineillusionjcgs,jsm2014,jsm2013}
  ...
  \end{itemize}
\item Statistical Graphics and Visual Aptitude: How are spatial reasoning abilities related to the ability to read statistical graphics? (\href{https://github.com/srvanderplas/VisualAptitude/blob/master/Paper/InfoVis2015Revision/TestingVisualAptitude.pdf}{Paper}) \cite{visualaptitude}. 
\item Hierarchy of Graphical Features: Which features of statistical graphics dominate the perceptual experience? Do colored points matter more than trend lines? (\href{https://raw.githubusercontent.com/srvanderplas/FeatureHierarchy/master/FullPaper/Draft1/features.pdf}{Paper})
\end{itemize}}

\tlcventry{2013}{2015.5}{Research Assistant, USDA Soybean Genome Project}{Iowa State University}{Ames, IA}{}{
\begin{itemize}
...
\tlcventry{2015}{0}{Engineering Statistician}{Cooper Nuclear Station}{Nebraska Public Power District}{}{Analyzed power plant business and engineering decisions to increase safety and profitability.}
